    ...
    >
      ...
      >
        ...
        <div class="relative bg-white rounded-lg shadow">
          {/* <!-- Modal header --> */}
          <div class="flex items-start justify-between gap-4 p-4 rounded-t">
            <h3 class="text-xl capitalize font-semibold text-gray-900">
              {title}
            </h3>
            <button
              type="button"
              class="bg-gray-400 text-white rounded-lg text-sm p-1.5 inline-flex items-center"
              onClick={close}
            >
